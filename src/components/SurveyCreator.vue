...
<template>
	<div ref="surveyCreatorContainer" />
</template>
...
export default {
	...
	mounted() {
		...
		// this.$refs['surveyCreatorContainer']
		this.surveyCreator = new SurveyCreator.SurveyCreator(this.$refs['surveyCreatorContainer'], options);
		// this.surveyCreator = new SurveyCreator.SurveyCreator(null, options);
		// this.surveyCreator.render(this.$refs['surveyCreatorContainer']);
